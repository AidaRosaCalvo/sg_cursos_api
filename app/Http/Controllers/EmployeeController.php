...
class EmployeeController extends Controller
{
    ...
    //Se utiliza en la vista de Profesores para controlar si activar o no el checkbox de Calificado
    ...
    //Devuelve los cursos que imparte y recibe un empleado
